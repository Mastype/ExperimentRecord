# -*- coding: utf-8 -*-
"""
Created on Tue Sep 19 22:16:33 2017
使用 小波变换价 LSTM 处理 股指数据 
股指为 S&P 500
@author: dell
"""
...
# 分解
cS2,cD2,cD1 = pywt.wavedec(origin, haar, level = 2)
# 重建
ori_re = pywt.waverec([cS2,None,None], haar)
ori_re = ori_re[:len(ori_re)-2]

#################################################
data = dict(a=ori_re, b=label)


#参数定义
LOG_DIR = './ops_logs/S&P500_WLSTM'   # 日志文件
TIMESTEPS = 3                # 预测的时间步长
